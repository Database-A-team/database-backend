...
export class FacilitiesService {
    ...
    async findOneById(id: number): Promise<Facility> {
        ...
        if(!facility) throw new NotFoundException(`Facility id : ${id} is not found`);
    ...
    async findOneByName(name: string): Promise<Facility> {
        ...
        if(!facility) throw new NotFoundException(`Facility name : ${name} is not found`);
    ...
    async update(id: number, updateFacilityInput: UpdateFacilityInput): Promise<Facility> {
