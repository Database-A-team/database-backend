...
export class ScreensResolver {
    ...
    @Mutation(() => Screen)
    createScreen(@Args('createScreenInput') createScreenInput: CreateScreenInput) {
        return this.screensService.createScreen(createScreenInput);
    }

    @Mutation(() => SpecialScreen)
    createSpecialScreen(@Args('createSpecialScreenInput') createSpecialScreenInput: CreateSpecialScreenInput) {
    ...
    @Mutation(() => Screen)
    updateScreen(@Args('updateScreenInput') updateScreenInput: UpdateScreenInput) {
        return this.screensService.updateScreen(updateScreenInput.id, updateScreenInput);
    }

    @Mutation(() => SpecialScreen)
    updateSpecialScreen(@Args('updateSpecialScreenInput') updateSpecialScreenInput: UpdateSpecialScreenInput) {
        return this.screensService.updateSpecialScreen(updateSpecialScreenInput.id, updateSpecialScreenInput);
    }
